...
const getProducts = (req: Request<any,any,any,SearchQuery>, res: Response, next: NextFunction)=>{
  const { category, search, from_price,to_price,page,item_per_page } = req.query
